...
class DcapAttestation(Attestation):
    ...
    def __init__(self, config, enclave_type):
        ...
        # This instance is required to call is_sgx_simulator function
        self._base_enclave_info = self.enclave_info.base_enclave_info()
    ...
    def init_enclave_info(self, signed_enclave, persisted_sealed_data,
        ...
        if not self._dcap_enclave_info:
            self._dcap_enclave_info = self.enclave_info.dcap_enclave_info(
    ...
    def is_sgx_simulator(self):
        ...
        """
        return self._base_enclave_info.is_sgx_simulator()
