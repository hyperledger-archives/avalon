...
class SingletonEnclaveInfo(BaseEnclaveInfo):
    """
    Singleton enclave info class to initialize enclave, signup enclave
    and hold data obtained post signup.
    """
    ...
    def __init__(self, config, worker_id):
        ...
        try:
            ...
            raise Exception("missing enclave initialization parameter; {}"
                            .format(str(ke)))
        self.worker_key_refresh = key_refresh.WorkerKeyRefresh(self, config, "singleton")
