...
class GrapheneWPESignupInfo(EnclaveAttributes):
    """
    Signup Object for Graphene WPE worker that will be
    used by BaseEnclave Manager
    """

# -------------------------------------------------------------------------
    def __init__(self, config, worker_signup_json):
        """
        Constructor for SignupGraphene for WPE worker.
        ...
        self.mr_enclave = worker_signup_json["mrenclave"]
