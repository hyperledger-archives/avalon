...
include_dirs = [
    ...
    os.path.join(enclave_bridge_wrapper_path, 'kme'),
    enclave_bridge_path,
    os.path.join(enclave_bridge_path, 'kme'),
...
enclave_module_files = [
    ...
    os.path.join(enclave_bridge_wrapper_path, 'kme/signup_info_kme.cpp')
]
