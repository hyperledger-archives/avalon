...
# -----------------------------------------------------------------
setup(name='graphene_wpe_enclave_manager',
      version = version,
      description = 'Avalon Graphene WPE Enclave Manager',
      ...
      entry_points = {
        'console_scripts':
        ['enclave_manager = avalon_enclave_manager.graphene_wpe.graphene_wpe_manager:main']
          }
)
