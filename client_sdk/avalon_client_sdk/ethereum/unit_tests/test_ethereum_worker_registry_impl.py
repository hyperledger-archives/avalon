...
from avalon_client_sdk.ethereum.ethereum_worker_registry_client \
     import EthereumWorkerRegistryClient
...
class TestEthereumWorkerRegistryImpl(unittest.TestCase):
    def __init__(self, config_file):
        ...
        self.__eth_conn = EthereumWorkerRegistryClient(self.__config)
