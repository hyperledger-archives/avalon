...
from avalon_client_sdk.direct.jrpc.worker_registry_jrpc_client import WorkerRegistryJRPCClientImpl
from avalon_client_sdk.direct.jrpc.work_order_jrpc_client import WorkOrderJRPCClientImpl
...
class AvalonDirectClient():
    ...
    def __init__(self, config_file=None, config=None):
        ...
        if self.__blockchain_type == "Ethereum":
                self.__worker_registry_list = EthereumWorkerRegistryListClientImpl(
                    self.__config)
        else:
            self.__worker_registry_list = None
        self.__worker_registry = WorkerRegistryJRPCClientImpl(self.__config)
        self.__work_order = WorkOrderJRPCClientImpl(self.__config)
        self.__work_order_receipts = WorkOrderReceiptJRPCClientImpl(self.__config)
