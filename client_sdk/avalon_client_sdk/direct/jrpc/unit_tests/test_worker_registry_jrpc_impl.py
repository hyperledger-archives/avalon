...
from avalon_client_sdk.direct.worker_registry_jrpc_client import WorkerRegistryJRPCClient
...
class TestWorkerRegistryJRPCImpl(unittest.TestCase):
    def __init__(self, config_file):
        ...
        self.__worker_registry_wrapper = WorkerRegistryJRPCClient(self.__config)
