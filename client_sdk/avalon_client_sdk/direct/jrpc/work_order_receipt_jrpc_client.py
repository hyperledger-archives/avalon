...
from avalon_client_sdk.interfaces.work_order_receipt_client \
    import WorkOrderReceiptClient
from avalon_client_sdk.utility.tcf_types import ReceiptCreateStatus

logging.basicConfig(
    format="%(asctime)s - %(levelname)s - %(message)s", level=logging.INFO)


class WorkOrderReceiptJRPCClientImpl(WorkOrderReceiptClient):
    """
