...
class WorkOrderClient(ABC):
    ...
    def encryption_key_retrieve(self, worker_id, last_used_key_nonce, tag,
        ...
        5. signatureNonce is an optional parameter and is used only
        ...
        1. errorCode is the result of the operation.
           ...
           or the requester retrieves keys, faster than the worker produces them.
