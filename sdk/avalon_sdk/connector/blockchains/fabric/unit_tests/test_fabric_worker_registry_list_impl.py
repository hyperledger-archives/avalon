...
from avalon_sdk.connector.blockchains.fabric.fabric_worker_registry_list \
    import FabricWorkerRegistryListImpl
...
class TestFabricWorkerRegistryListImpl(unittest.TestCase):
    def __init__(self, config_file):
        super(TestFabricWorkerRegistryListImpl, self).__init__()
        ...
        self.__fabric_conn = FabricWorkerRegistryListImpl(self.__config)
    ...
    def test_registry_add(self):
        ...
        result = self.__fabric_conn.registry_add(
    ...
    def test_registry_update(self):
        ...
        result = self.__fabric_conn.registry_update(
    ...
    def test_registry_retrieve(self):
        ...
        result = self.__fabric_conn.registry_retrieve(self.__org_id)
        logging.info(
...
def main():
    ...
    test = TestFabricWorkerRegistryListImpl(
        tcf_home +
