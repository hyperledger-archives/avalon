package com.iexec.eea.worker.tee.scone;

import com.iexec.eea.worker.chain.ContributionService;
import com.iexec.eea.worker.config.PublicConfigurationService;
import com.iexec.eea.worker.config.WorkerConfigurationService;
import com.iexec.eea.worker.sms.SmsService;
...
public class SconeTeeServiceTests {
    ...
    public void ShouldIsEnclaveSignatureValidBeTrue() {
        ...
        String resultSeal = ContributionService.computeResultSeal(worker, chainTaskId, deterministHash);
