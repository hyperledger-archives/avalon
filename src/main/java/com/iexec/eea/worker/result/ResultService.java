package com.iexec.eea.worker.result;
...
import com.iexec.eea.worker.tee.scone.SconeEnclaveSignatureFile;
...
import static com.iexec.eea.worker.utils.FileHelper.createFileWithContent;
...
public class ResultService {
    ...
    private File saveStdoutFileInResultFolder(String chainTaskId, String stdoutContent) {
        ...
        return FileHelper.createFileWithContent(filePath, stdoutContent);
    }
