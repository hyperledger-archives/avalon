...
import com.iexec.eea.worker.contract.generated.WorkOrderRegistry;
...
public class WorkOrderRegistryService {
    ...
    @Autowired
    public WorkOrderRegistryService(CredentialsService credentialsService, Web3jService web3JService,
