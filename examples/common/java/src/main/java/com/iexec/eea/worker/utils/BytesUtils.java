...
public class BytesUtils {
    ...
    public static boolean compareBytes(byte[] left, byte[] right, int length, int leftPadding, int rightPadding) {
        boolean same = true;
    ...
    public static boolean compareBytes(byte[] left, byte[] right, int leftPadding, int rightPadding) {
