...
# This is a helper script to build Graphenized docker image.
# Execute this script from graphene repo top level Tools/gsc directory.

# Openvino application docker image name.
IMAGE_NAME=openvinowl
# Graphenized docker image name.
...
# Manifest files
MANIFEST_FILE_DIR="${TCF_HOME}/examples/graphene_apps/cppopenvino/graphene"
MANIFEST_FILES="openvinowl.manifest"
