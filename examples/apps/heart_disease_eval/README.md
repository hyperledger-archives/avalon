...
5.  If you are running with Docker, then run this in Terminal 2:
    ...
    ./generic_client.py --workload_id "heart-disease-eval" \
        --in_data "Data: 25 10 1 67 102 125 1 95 5 10 1 11 36 1" -o -avs "http://avalon-avs:6090"
    ```
    ...
    ./generic_client.py --workload_id "heart-disease-eval" \
        ...
        --in_data "Data: 25 10 1 67 102 125 1 95 5 10 1 11 36 1" -o -avs "http://localhost:6090"
    ```
