...
#include "aml_plug-in.h"
#include "aml_logic.h"

REGISTER_WORKLOAD_PROCESSOR("aml-result",AmlResult)

AmlResult::AmlResult() {}

AmlResult::~AmlResult() {}

void AmlResult::ProcessWorkOrder(
    ...
    for (auto wo_data : in_work_order_data) {
        ...
        try {
            result_str = aml_result_logic->executeWorkOrder(inputData);
        } catch(...) {
