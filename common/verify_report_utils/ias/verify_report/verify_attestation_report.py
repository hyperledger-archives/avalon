...
import json
import logging
import verify_report.ias_verify_report as ias_report_util
...
def verify_ias_attestation_report(enclave_info):
    ...
    quote_status = ias_report_util.verify_quote(
                       verification_report,
    ...
    report_sig_status = ias_report_util.verify_ias_report_signature(
        ias_report_cert,
        verification_report,
        proof_signature)
