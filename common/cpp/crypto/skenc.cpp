...
/**
 * Generate symmetric authenticated encryption Initialization Vector (IV).
 * Throws RuntimeError.
 *
...
/**
 * Encrypt a message using authenticated encryption with random IV
 ...
 * @param iv  Initialization Vector (IV). Generated by GenerateIV()
 ...
 * appended to cipher text:
 * message = IV + ciphertext + authentication tag
 * IV was prepended by EncryptMessage().
 * Throws RuntimeError, ValueError.
 *
 * @param message binary data to decrypt. Generated by EncryptMessage()
 * @param key Secret AES-256 encryption key.
