...
sgx_status_t ecall_VerifyEnclaveInfoEpid(const char* enclave_info,
    const char* mr_enclave) {
    sgx_status_t sresult = SGX_SUCCESS;
    EpidSignupHelper signup_helper;
    sresult = signup_helper.verify_enclave_info(enclave_info, mr_enclave);
...
sgx_status_t ecall_VerifyEnclaveInfoDcap(const char* enclave_info,
    const char* mr_enclave) {
    Log(TCF_LOG_INFO, "In ecall_VerifyEnclaveInfoDcap");
    sgx_status_t sresult = SGX_SUCCESS;
