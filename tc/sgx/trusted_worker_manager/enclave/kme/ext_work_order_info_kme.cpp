...
int ExtWorkOrderInfoKME::VerifyAttestationWpe(
    ...
    SignupHelper *signup_helper = nullptr;
#if defined(BUILD_DCAP)
    signup_helper = new DcapSignupHelper();
#elif defined(BUILD_EPID)
    signup_helper = new EpidSignupHelper();
#endif
    return signup_helper->verify_attestation_report(attestation_data,
	hex_id,
	mr_enclave,
	mr_signer,
