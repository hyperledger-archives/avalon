...
*/
tcf_err_t WorkOrderHandlerWPE::HandleWorkOrderRequest(
    ...
    try {
        ...
        sgx_status_t sresult =
            g_Enclave[enclaveIndex].CallSgx(
                ...
                () {
                    sgx_status_t sresult_inner = ecall_HandleWorkOrderRequestWPE(
                        enclaveid,
                        &presult,
        ...
        tcf::error::ThrowSgxError(sresult,
            "Intel SGX enclave call failed (WorkOrderHandlerWPE)");
    ...
    return result;
}  // WorkOrderHandlerWPE::HandleWorkOrderRequest
