...
echo "sdk/avalon_sdk/connector/blockchains/fabric/chaincode" >> .git/info/sparse-checkout
git pull --depth=1 origin master
sudo cp -r sdk/avalon_sdk/connector/blockchains/fabric/chaincode ../vars
cd .. && rm -rf avalon
